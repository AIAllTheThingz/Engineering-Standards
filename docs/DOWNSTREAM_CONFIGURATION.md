...
For the downstream profile, each required document must contain at least 100 words and three headings (levels 1–3), with meaningful section bodies. HTML comments do not contribute words, headings, or section bodies, and fenced code headings do not count as document sections. Empty files, shallow stubs, and unresolved placeholders fail. Central authoritative documents retain their stricter depth and required-concept checks.
