...
try {
    ...
    if ($evidence.executionContext -eq 'Local' -and $evidence.githubHostedExecution.status -ne 'NotRun') { throw 'Local evidence must explicitly record GitHub-hosted execution as NotRun.' }
