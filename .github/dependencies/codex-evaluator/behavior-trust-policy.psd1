@{
    ...
    ApprovedConfigurations = @(
        @{
            Sha256 = '8964ff08a933e24662ea774c293989acf103c06630cc678a6b1f631a9f75fbce'
            SchemaVersion = '1.0.0'
            ...
            RetryPolicy = @{ MaximumTransportRetries = 1; RetryableReasons = @('ModelUnavailable', 'TransportTimeout', 'TransportFailure', 'ProviderError'); RetryDelaySeconds = 2; PreserveEveryAttempt = $false; RetryMalformedOutput = $false; RetryThresholdFailure = $false }
        ...
        @{
            Sha256 = '1a72cf44a7711cce75cca0f755bfc169df4517e1bb63e86d878ab962375ca763'
            SchemaVersion = '1.0.0'
            ConfigurationId = 'codex-skill-behavior-gpt-5.6-sol-medium-v1'
            EvaluatorVersion = '1.0.0'
            ScoringContractVersion = '1.0.0'
