...
This example demonstrates real adoption of the Engineering Standards repository for a `worker-service` project.
...
```powershell
pwsh -NoProfile -File scripts/Test-DocumentationCompleteness.ps1 -Path examples/worker-service-project
```
