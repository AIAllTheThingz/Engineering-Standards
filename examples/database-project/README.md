...
This example demonstrates real adoption of the Engineering Standards repository for a `database` project.
...
```powershell
pwsh -NoProfile -File scripts/Test-DocumentationCompleteness.ps1 -Path examples/database-project
```
