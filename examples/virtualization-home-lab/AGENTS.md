...
- Treat copied virtualization standards and adoption examples as inert review data and guidance.
- Do not connect to managers, hypervisors, hosts, clusters, storage, or live services.
- Do not retrieve credentials, expose secrets, change virtual infrastructure, or perform external writes.
...
Run `pwsh -NoProfile -File examples/virtualization-home-lab/tools/Test-Demo.ps1` from the Engineering Standards repository root.
