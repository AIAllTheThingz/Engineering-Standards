...
Apply both the [VCF PowerCLI automation standard](standards/POWERCLI_AUTOMATION_STANDARD.md) and the [PowerShell package](https://github.com/AIAllTheThingz/Public-Access-Agents/tree/af649326961de32adcd2c5644c4305fa893d4ade/languages/powershell). Use the vSphere standard for product boundaries and the PowerShell package for language engineering.
