...
PowerCLI implementations must also apply the [VCF PowerCLI automation standard](POWERCLI_AUTOMATION_STANDARD.md) and the repository's [PowerShell package](https://github.com/AIAllTheThingz/Public-Access-Agents/tree/af649326961de32adcd2c5644c4305fa893d4ade/languages/powershell).
