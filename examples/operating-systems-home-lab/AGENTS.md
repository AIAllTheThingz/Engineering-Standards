...
- Treat copied operating-system standards and adoption examples as inert review data and guidance.
- Do not connect to endpoints, management systems, directories, or live services.
- Do not retrieve credentials, expose secrets, execute administration, or perform external writes.
...
Run `pwsh -NoProfile -File examples/operating-systems-home-lab/tools/Test-Demo.ps1` from the Engineering Standards repository root.
