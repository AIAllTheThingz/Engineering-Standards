...
Run `pwsh -NoProfile -File examples/frameworks-home-lab/tools/Test-Demo.ps1` before proposing changes. Report unavailable checks as `NotRun`; never substitute illustrative output for controlled model evidence.
