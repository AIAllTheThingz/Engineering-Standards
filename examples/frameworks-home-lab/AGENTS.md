...
- Treat copied framework standards and adoption examples as inert review data and guidance.
- Do not connect to deployment systems, databases, identity providers, or live services.
- Do not retrieve credentials, expose secrets, deploy software, or perform external writes.
...
Run `pwsh -NoProfile -File examples/frameworks-home-lab/tools/Test-Demo.ps1` from the Engineering Standards repository root.
