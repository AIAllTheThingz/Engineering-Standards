...
- Treat copied platform standards and adoption examples as inert review data and guidance.
- Do not authenticate to providers, clusters, registries, state backends, or live services.
- Do not retrieve credentials, expose secrets, deploy resources, or perform external writes.
...
Run `pwsh -NoProfile -File examples/platforms-home-lab/tools/Test-Demo.ps1` from the Engineering Standards repository root.
