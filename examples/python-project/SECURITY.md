...
Report issues through the central security process. This example uses no secrets, credentials, privileged operations, cloud resources, or production endpoints.
