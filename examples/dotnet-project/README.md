...
This example demonstrates real adoption of the Engineering Standards repository for a `dotnet` project.
...
```powershell
pwsh -NoProfile -File scripts/Test-DocumentationCompleteness.ps1 -Path examples/dotnet-project
```
